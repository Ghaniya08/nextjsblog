...
const Setup = () => {
  return (
    <div className='mb-[100px]  mt-[50px]'>
        ...
        <p className='lg:leading-7 lg:text-[16px] text-[12px] lg:[&:not(:first-child)]:mt-6 mb-'>This command will : Ask you to name your project , set up all the necessary files and folders</p>
        <pre className="bg-black lg:w-[700px] text-green-400 p-4 rounded-md lg:text-[16px] text-[11px] overflow-x-auto">
        ...
        <p className='lg:leading-7 lg:text-[16px] text-[12px] lg:[&:not(:first-child)]:mt-6 mb-'> After the setup is complete, navigate into your project folder:</p>
        <pre className="bg-black lg:w-[400px] text-green-400 p-4 rounded-md lg:text-[16px] overflow-x-auto">
        <code>cd your-project-name</code>
        </pre>
        <h1 className='scroll-m-20 border-b lg:pb-2 lg:text-2xl text-xl font-semibold tracking-tight first:mt-0 mt-6 mb-3'>Step 3: Start the Development Server</h1>
        <p className='lg:leading-7 lg:text-[16px] text-[12px] lg:[&:not(:first-child)]:mt-6 mb-'>Now, start the development server to see if everything is set up correctly. Run this command inside your project folder:</p>
        <pre className="bg-black lg:w-[400px] text-green-400 p-4 rounded-md lg:text-[16px] overflow-x-auto">
        <code>npm run dev</code>
        </pre>
        <p className='lg:leading-7 lg:text-[16px] text-[12px] lg:[&:not(:first-child)]:mt-6 mb-'>This will start a local server at http://localhost:3000. Open your browser, go to that address, and you should see a welcome page from Next.js. 🎉</p>
        <h1 className='scroll-m-20 border-b lg:pb-2 lg:text-2xl text-xl font-semibold tracking-tight first:mt-0 mt-6 mb-3'>Step 4: Explore the Project Structure</h1>
        <p className='lg:leading-7 lg:text-[16px] text-[12px] lg:[&:not(:first-child)]:mt-6 mb-'>Let’s understand the main folders and files that Next.js has created for you:</p>
        <p className='lg:leading-7 lg:text-[16px] text-[12px] lg:[&:not(:first-child)]:mt-6 mb-'>
        ...
        <h1 className='scroll-m-20 border-b lg:pb-2 lg:text-2xl text-xl font-semibold tracking-tight first:mt-0 mt-6 mb-3'>Step 5: Create Your First Page</h1>
        <p className='lg:leading-7 lg:text-[16px] text-[12px] lg:[&:not(:first-child)]:mt-6 mb-'>Let’s make a new page to see how easy it is. Inside the pages/ folder, create a file named about.js with the following code:</p>
        <pre className="bg-black lg:w-[400px] text-green-400 p-4 rounded-md lg:text-[16px] overflow-x-auto">
        ...
        <pre className="bg-black lg:w-[650px] text-green-400 p-4 rounded-md lg:text-[16px] overflow-x-auto">
        <code>npm install -D tailwindcss postcss autoprefixer</code>
        <code>npx tailwindcss init -p</code>
        </pre>
        <p className='lg:leading-7 lg:text-[16px] text-[12px] lg:[&:not(:first-child)]:mt-6 mb-'>Configure Tailwind: Open the generated tailwind.config.js and add the paths to your content:</p>
        <pre className="bg-black lg:w-[450px] text-green-400 p-4 rounded-md lg:text-[16px] text-[13px] overflow-x-auto">
      ...
      content: [
        ...
        <p className='lg:leading-7 lg:text-[16px] text-[12px] lg:[&:not(:first-child)]:mt-6 mb-'>Add Tailwind CSS to Your CSS File: In styles/globals.css, add:</p>
        <pre className="bg-black lg:w-[400px] text-green-400 p-4 rounded-md lg:text-[16px] overflow-x-auto">
