...
const Setup = () => {
  return (
    <div className='mb-[100px]  mt-[50px]'>
        ...
        <p className='leading-7 [&:not(:first-child)]:mt-4 mb-5'>If you see version numbers, youre ready to go! If not, download and install Node.js.</p>
      ...
      content: [
        ...
        <p className='leading-7 [&:not(:first-child)]:mt-4 mb-5'>Once youre ready to share your project, you can deploy it easily on Vercel, which is also created by the Next.js team. Go to vercel.com, sign up, and follow the steps to deploy your project directly from GitHub.</p>
        </div>
