...
const page = () => {
  return (
    <div className='mt-[50px] mb-[100px]'>
        ...
        Version 7.0 was released in September 2018 with improved error handling and support for Reacts context API for improved dynamic route handling. This was also the first version to upgrade to Webpack 4.[19]
